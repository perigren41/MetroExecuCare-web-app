                ...
                <div className="flex-1 flex flex-col space-y-3 sm:space-y-4 items-start text-left">
                    ...
                    <div className="space-y-3 sm:space-y-4 text-sm">
                        ...
                        <div>
                            ...
                            <br />
                            <span className="text-gray-700 break-words">{profile.birthDate}</span>
                        </div>
        ...
        <GradientCard className="rounded-[24px] h-full bg-gradient-to-br from-gray-50 to-gray-100 border border-gray-200 shadow-sm">
            ...
            <div className="flex">
                <div className="flex-1 text-center">
                    ...
                    <p className="text-2xl xl:text-3xl font-bold text-gray-700">{approvedRequests}</p>
                </div>
                ...
                <div className="flex-1 text-center">
                    ...
                    <p className="text-2xl xl:text-3xl font-bold text-gray-700">{rejectedRequests}</p>
                </div>
            </div>
        </GradientCard>
    );
