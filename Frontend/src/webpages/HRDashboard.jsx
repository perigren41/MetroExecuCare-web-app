            ...
            <div className="min-h-screen flex flex-col">
                ...
                >
                    ...
                    <div className="px-6 pt-16 flex flex-col items-center text-center">
                        ...
                        <div
                            className="bg-white rounded-[40px] flex flex-col items-center justify-center p-4 sm:p-6 mx-auto"
                            style={{
                                width: screenSize === 'mobile' ? 'min(300px, 90vw)' : '337px',
                                maxWidth: '90vw',
                                minHeight: '257px',
                        ...
                        >
                            ...
                            <div className="mb-2 sm:mb-3">
                                <img src={PendingRequestsLogo} alt="Pending Requests" className="w-[60px] h-[60px] sm:w-[75px] sm:h-[75px]" />
                            </div>

                            {/* Pending Requests Title */}
                            <h2 className="text-xl sm:text-2xl font-bold mb-2" style={{ color: '#023184' }}>
                                Pending Requests
                            </h2>

                            {/* Description Text with styled numbers */}
                            <p className="text-center text-sm sm:text-base mb-3 sm:mb-4 px-2 sm:px-4" style={{ color: '#484848' }}>
                                {loading ? "Loading..." : getStyledMessage(message)}
                            </p>

                            {/* Review Now Button */}
                            <button
                                className="text-sm sm:text-base text-white rounded-full flex items-center justify-center gap-2 cursor-pointer px-4 py-1.5"
                                style={{
                            ...
                            >
                                Review now
                                <img src={RoundArrowIconWhite} alt="Arrow" className="w-4 h-4 sm:w-5 sm:h-5" />
                            </button>
                        </div>
                    </div>
                </div>
