...
export default function SubmitLetterOfAuthorization() {
  ...
  return (
    <>
      ...
      {/* Container */}
      <div className="flex justify-center px-2 sm:px-4 py-2 sm:py-4 max-w-7xl mx-auto">
        <div className="w-full max-w-5xl bg-white rounded-2xl sm:rounded-3xl shadow-xl shadow-[#00539F]/30 px-4 sm:px-6 md:px-8 py-3 sm:py-4 md:pb-8 md:pt-4
        border border-gray-200
        outline outline-[#00539F]">
          <h2 className="text-sm sm:text-base md:text-lg font-semibold text-center text-blue-900 mb-2 sm:mb-4">
            Details
          </h2>

          {/* Desktop/Tablet Layout: Upload - Document - Submit */}
          <div className="hidden sm:flex items-center justify-center space-x-4 md:space-x-8 lg:space-x-12">
          ...
          <div className="sm:hidden flex flex-col items-center space-y-4 sm:space-y-6 py-3 sm:py-4">
      ...
      {showUploadModal && (
        <div className="fixed inset-0 bg-black/20 backdrop-blur-sm flex items-center justify-center z-50 p-2 sm:p-4">
          {/* Modal Container */}
          <div className="bg-white rounded-2xl sm:rounded-3xl shadow-xl w-full max-w-sm sm:max-w-md md:max-w-lg mx-2 sm:mx-4 overflow-hidden">
            {/* Modal Header */}
            <div className="bg-[linear-gradient(to_right,#3F6EC0_2%,#00539F_30%,#5D3EA4_50%,#7940A8_75%)]
            flex items-center justify-between text-white px-3 sm:px-4 py-2 sm:py-3">
              ...
              {tempFiles.length === 0 ? (
                ...
                <div
                  className={`flex flex-col items-center justify-center rounded-xl sm:rounded-2xl
                    transition-all duration-200 cursor-pointer px-6 sm:px-12 md:px-20 py-6 sm:py-8 md:py-10 text-xs sm:text-sm
                    ${isDragOver
                      ? 'bg-blue-50'
                      : 'hover:bg-gray-50'
                    }`}
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black/20 backdrop-blur-sm flex items-center justify-center z-50 p-2 sm:p-4">
          <div className="bg-white rounded-2xl sm:rounded-3xl shadow-lg max-w-xs sm:max-w-md md:max-w-lg w-full relative overflow-hidden mx-2 sm:mx-4">
            {/* Header */}
            <div className="flex justify-between items-center
              bg-[linear-gradient(to_right,#3F6EC0_2%,#00539F_30%,#5D3EA4_50%,#7940A8_75%)]
              text-white px-3 sm:px-4 py-2 sm:py-3"
            >
              ...
              {modalState === 'success' && (
                <div className="text-center py-2 sm:py-4">
                  ...
                  <p className="text-xs sm:text-sm text-gray-600 mb-3 sm:mb-4 leading-relaxed">
                    Your Letter of Approval request has been successfully submitted with the uploaded document.
