    ...
    <div className="fixed inset-0 bg-black/20 backdrop-blur-sm flex items-center justify-center z-50 p-2 sm:p-4">
      <div className="bg-white rounded-2xl sm:rounded-3xl shadow-lg w-full max-w-sm sm:max-w-xl h-auto relative overflow-hidden max-h-[95vh] sm:max-h-[90vh] overflow-y-auto">
        ...
        <form
          ...
          className="grid grid-cols-1 sm:grid-cols-[7fr_14fr_auto] grid-rows-[auto] gap-1 sm:gap-1 p-3 sm:p-5 text-xs items-start text-left"
        >
          {/* First Name */}
          <label className="font-medium text-blue-900 sm:col-span-1">First Name</label>
          <input
            type="text"
            name="FirstName"
            ...
            required
            className={`border rounded-sm gap-1 py-0 text-xs w-full px-1 sm:col-span-1 ${borderClass(
              "FirstName"
            )}`}
          />
