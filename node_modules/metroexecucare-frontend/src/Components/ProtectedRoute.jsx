  ...
  if (requiredRoles.length > 0 && user) {
    ...
    if (!hasRequiredRole) {
      ...
      if (userRole === 'admin') {
        ...
        return <Navigate to="/benefits-dashboard" replace />;
...
export const BenefitsRoute = ({ children }) => (
  <ProtectedRoute requiredRoles={['benefits_officer']}>
    {children}
  </ProtectedRoute>
);

export const WelfareRoute = ({ children }) => (
  <ProtectedRoute requiredRoles={['welfare_head']}>
    {children}
  </ProtectedRoute>
);
...
// Multi-role route for shared HR/Benefits/Welfare functionality
export const WorkflowRoute = ({ children }) => (
  <ProtectedRoute requiredRoles={['hr_personnel', 'benefits_officer', 'welfare_head']}>
    {children}
  </ProtectedRoute>
);